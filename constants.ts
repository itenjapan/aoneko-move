...
export const VEHICLES: Vehicle[] = [
  {
    id: 'keivan',
    name: 'Light Van',
    displayName: 'Light Van (軽バン)',
    basePrice: 1580,
    perKmPrice: 150,
    capacity: '箱(60x30cm)10個 / スーツケース6個まで',
    dimensions: '高さ120cm × 幅140cm × 奥行190cm',
    maxWeight: 350,
    description: '屋根付きで雨天でも安心。空港送迎や個人の引越しに最適です。規定量を超える荷物は追加料金が発生します。',
    icon: '🚐',
    image: KEI_VAN_SVG
  },
  {
    id: 'keitruck', 
    name: 'Pick-up',
    displayName: 'Pick-up (軽トラック)',
    basePrice: 1780,
    perKmPrice: 160,
    capacity: '冷蔵庫 / 大型観葉植物 / 建材',
    dimensions: '幅140cm × 奥行190cm',
    maxWeight: 350,
    description: '高さのある荷物も積載可能。積み下ろしが容易なトラックタイプ。',
    icon: '🛻',
